...
def download_haar_cascades():
    ...
    print("Haarcascade XML files are ready.")
...
method = None  # Başlangıçta yöntem yok
...
while True:
    ...
    # Aktif yöntemi ekrana yaz
    if method:
        cv2.putText(frame, f"Yontem: {method.capitalize()}", (10, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)

    # Yöntem seçildiğinde ROI penceresini aç
